...
export default function Register() {
  ...
  const getInputClass = (field) =>
    `w-full bg-gray-800 border text-white font-mono text-sm px-4 py-3 rounded focus:outline-none transition-colors ${
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-gray-900 border-2 border-gray-700 rounded p-8"
          ...
          <h2 className="text-white font-mono font-bold text-xl mb-6 flex items-center gap-2">
            <span className="text-yellow-400">★</span> CREATE ACCOUNT
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div>
              ...
              {touched.password && fieldErrors.password ? (
                ...
                <p className="text-gray-600 font-mono text-xs mt-1">Min 6 characters with letters and numbers</p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-yellow-400 hover:bg-yellow-300 disabled:bg-gray-700 disabled:text-gray-500 text-black font-mono font-bold py-3 rounded transition-colors mt-2"
              style={{ boxShadow: loading ? "none" : "2px 2px 0px #ca8a04" }}
            >
